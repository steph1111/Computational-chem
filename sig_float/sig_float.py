...
def round_sig(number, sig_figs: int):  #->sig_float
  ...
  """
    ...
    rounded_number = str(
        round(float_number,
              sig_figs - int(math.floor(math.log10(abs(float_number)))) - 1))
  ...
  """
    ...
    """
        ...
        if not isinstance(other, sig_float):
            ...
            warnings.warn("Warning: Operands should be of type sig_float",
        ...
        return_product = round_sig(
            product, product_sig_figs)  # Rounds to proper sig figs
    ...
    """
        ...
        return_quotient = round_sig(
            quotient, quotient_sig_figs)  # Rounds to proper sig figs
